...
describe('Entity - базовый класс для игровых сущностей', () => {
    ...
    describe.skip('isIntersect - метод, определяющий пересекаются ли сущности', () => {
    ...
    describe.skip('distance - метод, определяющий расстояние между сущностями', () => {
        const e0_0 = new Entity({ x: 0, y: 0 }, 5);
        const e10_10 = new Entity({ x: 10, y: 10 }, 5);
        const e0_5 = new Entity({ x: 0, y: 5 }, 5);
        const e0_10 = new Entity({ x: 0, y: 10 }, 5);
    ...
    describe.skip('isInWorld - проверяет находится ли сущность в допустимых координатах', () => {
